...
namespace Exercises
{
    public static class FirstLast
    {
        ...
        public static string FindFirstNameInTheCollection(IEnumerable<string> words)
        {
            ...
            return words.FirstOrDefault(w=>w.Length>2 && char.IsUpper(w[0]) && w.Skip(1).All(char.IsLower));
        }
        ...
        {
            //TODO your code goes here
            return people.FirstOrDefault(s=> s.DateOfBirth== people.Max(x => x.DateOfBirth));
        }
